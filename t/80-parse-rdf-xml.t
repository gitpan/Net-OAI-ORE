...
#
# $Id: 80-parse-rdf-xml.t,v 1.7 2010-09-01 21:13:40 simeon Exp $
use strict;
...
{
  my $rem=Net::OAI::ORE::ReM->new('debug'=>1);
...

{
  ...
  is( ref($rem->creator), 'Net::OAI::ORE::Agent', "check ReM creator is agent" );
